...
SCHEDULER_TRACKER_FILE = os.path.join(SCHEDULER_DIRECTORY, "tracker.json")
...
SCHEDULER_TRACKER_AUTOSAVES_FILE = os.path.join(
    SCHEDULER_AUTOSAVES_DIRECTORY, "tracker.json"
)
SCHEDULER_NOTES_AUTOSAVES_FILE = os.path.join(
    SCHEDULER_AUTOSAVES_DIRECTORY, "notes.txt"
)

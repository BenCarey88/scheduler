...
from api.edit.composite_edit import CompositeEdit

from ._base_edit import Arguments, BaseEdit, EditError


class EditOperation(object):
    """Enum representing an edit operation on a dictionary or tree."""
    ADD = "Add"
    INSERT = "Insert"
    REMOVE = "Remove"
    RENAME = "Rename"
    ...
    def _run(self, ordered_dict):
        ...
        if define_inverse:
            ...
            self._inverse_edit = OrderedDictEdit.as_inverse(
                call_args=Arguments(self._arguments),
                init_args=Arguments(
